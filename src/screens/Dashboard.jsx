...
const Dashboard = () => {
  ...
  const [user, setUser] = useState(() => (JSON.parse(localStorage.getItem('bird-app'))).loggedIn)
  const [localState, setLocalState] = useState(() => JSON.parse(localStorage.getItem('bird-app')))
            ...
            <div className="list-links-div">
              <div className="nav-links">
                <div className="nav-link">
                  <div className="link-icon"><FontAwesomeIcon icon={faHouseUser} size="lg" /></div>
                  <div className="link-title">Home</div>
                </div>
                <div className="nav-link">
                  <div className="link-icon"><FontAwesomeIcon icon={faHashtag} size="lg" /></div>
                  <div className="link-title">Explore</div>
                </div>
                <div className="nav-link">
                  <div className="link-icon"><FontAwesomeIcon icon={faBell} size="lg" /></div>
                  <div className="link-title">Notifications</div>
                </div>
                <div className="nav-link">
                  <div className="link-icon"><FontAwesomeIcon icon={faEnvelope} size="lg" /></div>
                  <div className="link-title">Messages</div>
                </div>
                <div className="nav-link">
                  <div className="link-icon"><FontAwesomeIcon icon={faUser} size="lg" /></div>
                  <div className="link-title">Profile</div>
                </div>
                <div className="nav-link">
                  <div className="link-icon"><FontAwesomeIcon icon={faEllipsis} size="lg" /></div>
              ...
              <div className="profile-btn-div">
                ...
                <div className="tweets-btn-div">
                  <div className="login-btn tweet-btn" onClick={handleLogout}>Logout</div>
                </div>
            ...
            <div className="feeds-div">
              ...
              <div className="create-tweet-div">
                ...
                <div className="create-div">
                  ...
                  <div className="tweet-scope"><FontAwesomeIcon icon={faEarthAmericas} /> Everyone can reply</div>
                  <div className="tweet-btn-div">
                    <input type="file" onChange={handleFileChange} />
                    <div className="tweet-options"><FontAwesomeIcon icon={faImage} size="lg" /></div>
                    <div className="tweet-btn create-tweet-btn" onClick={handleTweet}>Tweet</div>
                  </div>
                </div>
              ...
              {
                localState.feed && localState.feed.map(item => <Feed data={item} key={item.postId} />)
              }
                ...
                <div className="trending-feeds">
                  ...
                  <div className="trending-feed">
                    <div className="feed-data">
                      <div className="feed-category">India National News . LIVE</div>
                      <div className="feed-title">Tributes pour in for Kargil martyrs on the 23rd anniversary of the war</div>
                      <div className="feed-tweets">Trending with <span className="text-blue">#IndianAry</span>, <span
                        className="text-blue"> #KargilVijayDiwas</span></div>
                    </div>
                    <div className="feed-img">
                      <img src="https://pbs.twimg.com/semantic_core_img/1551595760184987648/Pxz7dn3b?format=jpg&name=120x120"
                        alt="feed image" />
                    </div>
                  </div>
                  ...
                  <div className="trending-feed">
                    <div className="feed-data">
                      ...
                      <div className="feed-title">Health experts explain the difference between monkeypox and COVID-19</div>
                    </div>
                    <div className="feed-img">
                      <img src="https://pbs.twimg.com/semantic_core_img/1529038027091169280/KkaBuo64?format=jpg&name=120x120"
                        alt="feed image" />
                    </div>
                  </div>
                  ...
                  <div className="trending-feed">
                    <div className="feed-data">
                      ...
                      <div className="feed-title">Latest updates on the war in Ukraine</div>
                    </div>
                    <div className="feed-img">
                      <img src="https://pbs.twimg.com/semantic_core_img/1551548666204147713/3RBFvyaQ?format=jpg&name=120x120"
                        alt="feed image" />
                    </div>
                  </div>
              ...
              <div className="follow-section">
                ...
                <div className="follow-feeds">
                  ...
                  <div className="follow-feed">
                    <div className="follow-profile-pic">
                      <img src="https://pbs.twimg.com/profile_images/1418658538688155648/CREA-CYu_400x400.jpg"
                        alt="profile picture" />
                    </div>
                  ...
                  <div className="follow-feed">
                    <div className="follow-profile-pic">
                      <img src="https://pbs.twimg.com/profile_images/1284167924123500545/5cloQkyv_400x400.jpg"
                        alt="profile picture" />
                    </div>
                    <div className="follow-profile-div">
                      <div>Roshan Horo</div>
                      <div className="follow-username">@_dizit</div>
                    </div>
                    <div className="follow-btn-div">
                      <div>Follow</div>
                    </div>
